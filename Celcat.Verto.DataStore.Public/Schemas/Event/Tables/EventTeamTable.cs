namespace Celcat.Verto.DataStore.Public.Schemas.Event.Tables
{
    ...
    internal class EventTeamTable : PublicEventTable
    {
        public EventTeamTable()
           : base("EVENT_TEAM")
        {
            ...
            AddColumn(new Ct7UniqueNameColumn("team_unique_name"));
            AddColumn(new Ct7NameColumn("team_name"));

            AddPrimaryKey("event_instance_id", "team_id");
        }
