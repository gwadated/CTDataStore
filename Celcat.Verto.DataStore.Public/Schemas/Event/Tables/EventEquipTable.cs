namespace Celcat.Verto.DataStore.Public.Schemas.Event.Tables
{
    ...
    internal class EventEquipTable : PublicEventTable
    {
        public EventEquipTable()
           : base("EVENT_EQUIP")
        {
            ...
            AddColumn(new Ct7UniqueNameColumn("equip_unique_name"));
            AddColumn(new Ct7NameColumn("equip_name"));

            AddPrimaryKey("event_instance_id", "equip_id");
        }
